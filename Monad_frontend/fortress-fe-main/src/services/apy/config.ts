...
const apyEnvSchema = z.object({
  ...
  AAVE_POOL_BASE: z.string().regex(/^0x[a-fA-F0-9]{40}$/).default("0xA238Dd80C259a72e81d7e4664a9801593F98d1c5"),
});

export type ApyConfig = z.infer<typeof apyEnvSchema>;

export function loadApyConfig(env: Record<string, string | undefined> = process.env): ApyConfig {
